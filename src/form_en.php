<?php 
    if (isset($_POST["enviar"])){
        ...
        echo"
            <script>
                alert('Your form was successfully opened! This is your Pyramid number: $row[0]')
            </script>
        ";
                ...
                <div class="uk-width-1-1" >
                    <form class="uk-grid-small" uk-grid method="POST" action="">
                        ...
                        <div class="uk-width-1-1@s">
                            <h4 style="border-top-style: solid; border-width:1px; border-color:lightgray">Personal Information</h4>
                        </div>
                        <div class="uk-width-1-1@s">
                            <input class="uk-input" type="text" placeholder="Full Name" name="nome" required>
                        </div>
                        ...
                        <div class="uk-width-1-2@s">
                            <input class="uk-input" type="text" placeholder="Occupation" name="funcao" required>
                        </div>
                        ...
                        <div class="uk-width-1-1@s" style="display:flex">
                            <div class="uk-width-1-2@s">
                                <label><input class="uk-radio" type="radio" name="n_evento" value="Instalacoes"> Installations</label>
                            </div>
                            <div class="uk-width-1-2@s">
                                <label><input class="uk-radio" type="radio" name="n_evento" value="Comportamento"> Behavior</label>
                            </div>
                        </div>
                        <div class="uk-width-1-1@s">
                            <input class="uk-input" type="text" placeholder="Event Description" name="event_desc">
                        </div>

                        <div class="uk-width-1-1@s">
                            <h4 style="border-top-style: solid; border-width:1px; border-color:lightgray">Envolved Equipments</h4>
                        </div>
                        <div class="uk-width-1-1@s" style="display:flex">
                            <div class="uk-width-1-4@s">
                        ...
                        <div class="uk-width-1-1@s">
                            <input class="uk-input" type="text" placeholder="Equipment Description" name="equip_desc" id="equip_desc" onclick="habilitar()" disabled>
                        </div>
                        ...
                        <div class="uk-width-1-1@s" style="display:flex">
                            ...
                            <div class="uk-width-1-3@s">
                                <label><input class="uk-radio" type="radio" name="colaborador" value="Terceiro" id="terceiro" onclick="habilitar2()"> External/Visitor:</label>
                            </div>
                            <div class="uk-width-1-3@s">
                        ...
                        <div class="uk-width-1-1@s">
                            <strong><input class="uk-button uk-button-primary" type="submit" name="enviar" value="SEND" style="border-radius:5px"></strong>
                        </div>
